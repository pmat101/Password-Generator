...
function generatePassword(lower, upper, number, symbol, length) {
  if (!lower.checked) delete randomFunc.lower;
  if (!upper.checked) delete randomFunc.upper;
  if (!number.checked) delete randomFunc.number;
  if (!symbol.checked) delete randomFunc.symbol;
  let password = [];
